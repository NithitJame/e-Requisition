// Shared filter form for the promotion/trade-agreement listing screens (AllPA, AllTA, Approve):
// channel / category / month / fiscal year / status selectors plus the action buttons.
// Presentational only — all state lives in the page's listing hook.

import * as React from 'react';
import Form from 'react-bootstrap/Form';

import SearchableSelect from '@/shared/components/SearchableSelect';
import { IPromotionListingFiltersProps } from './PromotionListingFilters.types';
import styles from './PromotionListingFilters.module.scss';

const PROMOTION_WEEKS = ['W1-2', 'W3-4', 'All'] as const;

const PromotionListingFilters: React.FC<IPromotionListingFiltersProps> = ({
  filters,
  options,
  onChange,
  onSearch,
  ...
  <>
    <div className="row">
      <div className="col-12 col-xl-3 col-lg-4 col-md-6">
        <label className={`fw-bold ${showChannelClear ? 'mb-1' : 'mb-2'}`}>
          Channel
          {showChannelClear ? (
            <button
...
export default PromotionListingFilters;
